...
class Apic():
    ...
    def aci_set_bd(self, bd_name, tenant_name, vrf_name, l3_out, delete=False):
    ...
    def aci_get_epg(self, epg_name, tenant_name):
    ...
    def aci_set_static_binding_vpc(self, tn_name, ap_name, epg_name, policy_grp, vlan, trunk=True, delete=False):
        if trunk:
            mode = 'regular'
        else:
            mode = 'native'
...
if __name__ == '__main__':
    apic = Apic()
    apic.login('Sandbox')
    #resp = apic.aci_get_interface_profile('101')
    #print apic.aci_set_interface_selector('IP_LEAF_101', 'IS_Intf-39', '39', 'IPG_vPC_101_39_102_39')
    #print apic.aci_get_interface_selector('IP_LEAF_101', 'IS_Intf-39')
    #print apic.test()
    #print apic.test2()
    #print apic.test3()
    ...
    #print resp
    print apic.aci_set_bd('BD_10.10.10.0', 'common', 'VRF_GLOBAL', 'L3OUT_GEN3')
    print apic.aci_set_epg('EPG_10.10.10.0', 'MIXED', 'AP_MIXED', 'BD_10.10.10.0', 'PDOM_GLOBAL')
